...
class ContractCache(BaseManager):
    ...
    def clear_local_caches(self):
        self.chain_manager.contracts._local_contract_types = {}
        self.chain_manager.contracts._local_proxies = {}
        self.chain_manager.contracts._local_deployments_mapping = {}
...
class ReportManager(BaseManager):
    ...
    def _get_console(self, file: IO[str]) -> RichConsole:
        file_id = str(file)
